...
import 'firebase_options.dart'; // ignore: uri_does_not_exist
...
void main() async {
  ...
  await Firebase.initializeApp(options: DefaultFirebaseOptions.currentPlatform); // ignore: undefined_identifier
